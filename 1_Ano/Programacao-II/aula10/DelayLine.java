...
/**
 * Implementa uma linha de atraso. Trata-se de uma fila, mas de tamanho fixo e
 * com acesso direto a qualquer dos elementos (amostras), através do get(pos).
 * Não tem out(). Apenas tem in(x), que acrescenta uma nova amostra e
 * simultaneamente descarta a mais antiga.
 */
