...
namespace PROJFORM{
    ...
    public partial class AluguerForm : Form{
        ...
        private void RegistaAluguer(){
            if (!verifySGBDConnection())
                return;
            SqlCommand cmd = new SqlCommand();

            cmd.CommandText = "INSERT Aluguer VALUES (@NIF, @Matricula, @inicio, @fim, @montante) ";
            cmd.Parameters.Clear();
            cmd.Parameters.AddWithValue("@NIF", textBoxClientNIF.Text);
            cmd.Parameters.AddWithValue("@Matricula", textBoxMatricula.Text);
            cmd.Parameters.AddWithValue("@inicio", dateTimePickerInicio.Value);
            cmd.Parameters.AddWithValue("@fim", dateTimePickerFim.Value);
