...
public class SenteNatureza { 
	...
	private static void test(PrintStream out) {
		OpRegistry op = new OpRegistry();
		CatalogAdmin ctgAdmin = new BaseCatalogAdmin(op);
...
//		// alínea c)
		...
		alineaD(out, op);  // descomentar após concluir alinea D

	}
	
	private static void alineaD(PrintStream out, OpRegistry op) {
		out.println("\nAlínea d) ----------------------------------\n");
		out.println(op.getOperations());
	}
